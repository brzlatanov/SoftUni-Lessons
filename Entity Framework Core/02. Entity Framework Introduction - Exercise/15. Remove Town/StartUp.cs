...
namespace SoftUni
{
    public class StartUp
    {
        ...
        public static string GetEmployeesByFirstNameStartingWithSa(SoftUniContext context)
        {
            ...
            var employees = context.Employees.Where(e => e.FirstName.ToLower().StartsWith("sa")).Select(e=> new{e.FirstName, e.LastName, e.JobTitle, e.Salary}).OrderBy(e => e.FirstName).ThenBy(e=> e.LastName);
        ...
        {
            var employeeProject = context.EmployeesProjects.Where(p=> p.ProjectId == 2).ToArray();
        ...
        {
            var employeesToAlter = context.Employees.Where(e => e.Address.Town.Name == "Seattle");

            foreach (var employee in employeesToAlter)
            {
            ...
            var addressesToRemove = context.Addresses.Where(a => a.Town.Name == "Seattle");

            int addressesRemoved = addressesToRemove.Count();
