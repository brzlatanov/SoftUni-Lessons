...
namespace CarDealer
{
    public class StartUp
    {
        ...
        public static string GetSalesWithAppliedDiscount(CarDealerContext context)
        {
            ...
            string salesToString = JsonConvert.SerializeObject(salesWithDiscount, Formatting.Indented);

            File.WriteAllText("sales-discounts.json", salesToString);

            return salesToString;
        }
