...
namespace Drones
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            Drone drone2 = new Drone("", "DEERC", 6);
            Drone drone3 = new Drone("asd", "", 6);
            Drone drone4 = new Drone("asd", "asdasd", -1);
            //Print Drone
            ...
            Console.WriteLine(airfield.AddDrone(drone2));
            Console.WriteLine(airfield.AddDrone(drone3));
            Console.WriteLine(airfield.AddDrone(drone4)); // Successfully added D20 to the airfield.
            Console.WriteLine(airfield.Count); // 1

            // Remove Drone
            Console.WriteLine(airfield.RemoveDrone("DE51"));  // False
            Console.WriteLine(airfield.RemoveDrone("asd"));
            Console.WriteLine(airfield.RemoveDrone("D20"));
