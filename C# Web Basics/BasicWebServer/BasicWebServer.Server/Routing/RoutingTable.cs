...
using BasicWebServer.Server.Routing.Interfaces;
using System;
...
namespace BasicWebServer.Server.Routing
{
    public class RoutingTable : IRoutingTable
    {
        ...
        private IRoutingTable MapGet(
            ...
            Func<Request, Response> responseFunction)
        {
            Guard.AgainstDuplicatedKey(this.routes[Method.Get], path, "Routes.Get");
        ...
        private IRoutingTable MapPost(
         string path,
            Func<Request, Response> responseFunction)
        {
            Guard.AgainstDuplicatedKey(this.routes[Method.Post], path, "Routes.Post");
